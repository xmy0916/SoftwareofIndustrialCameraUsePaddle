...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.pushButton_show_devices.setGeometry(QtCore.QRect(10, 40, 121, 28))
        self.pushButton_show_devices.setObjectName("pushButton_show_devices")
        self.label_exposeur_time = QtWidgets.QLabel(Dialog)
        self.label_exposeur_time.setGeometry(QtCore.QRect(10, 200, 141, 31))
        ...
        self.lineEdit_exposeur_time.setGeometry(QtCore.QRect(160, 200, 101, 31))
        self.lineEdit_exposeur_time.setObjectName("lineEdit_exposeur_time")
        self.label_gain = QtWidgets.QLabel(Dialog)
        self.label_gain.setGeometry(QtCore.QRect(10, 250, 141, 31))
        ...
        self.lineEdit_gain.setGeometry(QtCore.QRect(160, 250, 101, 31))
        self.lineEdit_gain.setObjectName("lineEdit_gain")
        self.label_frame_rate = QtWidgets.QLabel(Dialog)
        self.label_frame_rate.setGeometry(QtCore.QRect(10, 300, 141, 31))
        ...
        self.lineEdit_frame_rate.setGeometry(QtCore.QRect(160, 300, 101, 31))
        self.lineEdit_frame_rate.setObjectName("lineEdit_frame_rate")
        self.pushButton_get_parameter = QtWidgets.QPushButton(Dialog)
        self.pushButton_get_parameter.setGeometry(QtCore.QRect(10, 340, 121, 28))
        ...
        self.pushButton_set_parameter.setGeometry(QtCore.QRect(150, 340, 111, 28))
        ...
        self.pushButton_close.setGeometry(QtCore.QRect(70, 380, 121, 28))
        self.pushButton_close.setObjectName("pushButton_close")
        self.pushButton_set_IP = QtWidgets.QPushButton(Dialog)
        self.pushButton_set_IP.setGeometry(QtCore.QRect(150, 40, 111, 28))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_set_IP.setText(_translate("Dialog", "Set IP"))
